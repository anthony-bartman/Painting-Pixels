...
class GraphicsContext
{
	public:
		...
		/* This is Bresenham's Circle Drawing Alogirthm
		 * 
		 * Parameters:
	...
	protected:
		...
		bool run;
	private:
		/* This will tell which way line to be created 
		 * 
		 * Parameters:
		 * 	x0, y0 - origin/center of circle
		 *  radius - radius of circle
		 */
		void lineDirection(int& incx, int& dx, int& incy, int& dy);
		
		/* This plots 1/8th of a circle by using "setPixel"
		 *
		 * Parameters:
		 * 	x0, y0 - origin/center of circle
		 *  radius - radius of circle
		 */
		void plotEigthCircle(int xcenter,int ycenter,int x, int y);	
};
